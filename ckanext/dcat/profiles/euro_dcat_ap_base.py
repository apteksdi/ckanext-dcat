...
class BaseEuropeanDCATAPProfile(RDFProfile):
    ...
    def _parse_dataset_base(self, dataset_dict, dataset_ref):
        ...
        for key, predicate in (
            ...
            ("iv_metode_pengumpulan_data", DCT.iv_metode_pengumpulan_data,None, Literal),
    ...
    def _graph_from_dataset_base(self, dataset_dict, dataset_ref):
        ...
        items = [
            ...
            ("accrualPeriodicity", DCT.accrualPeriodicity, None, URIRefOrLiteral, DCT.accrualPeriodicity),
            ("access_rights", DCT.accessRights, None, URIRefOrLiteral, DCT.AccessRights),
            ("dcat_type", DCT.type, None, URIRefOrLiteral),
            ("publisher_type", DCT.publisher_type, None, Literal),
            ("prioritas_tahun", DCT.prioritas_tahun, None, Literal),
            ("accessRights", DCT.accessRights, None, Literal),
            ("id_msind", DCT.id_msind, None, Literal),
            ("id_mskeg", DCT.id_mskeg, None, Literal),
            ("cara_pengumpulan_data", DCT.cara_pengumpulan_data, None, Literal),
            ("i_alamat", DCT.i_alamat, None, Literal),
            ("i_email", DCT.i_email, None, Literal),
            ("i_instansi_penyelanggara", DCT.i_instansi_penyelanggara, None, Literal),
            ("i_telepon", DCT.i_telepon, None, Literal),
            ("id_dds", DCT.id_dds, None, Literal),
            ("id_indikator_mms", DCT.id_indikator_mms, None, Literal),
            ("id_kegiatan", DCT.id_kegiatan, None, Literal),
            ("id_kegiatan_mms", DCT.id_kegiatan_mms, None, Literal),
            ("identitas_rekomendasi", DCT.identitas_rekomendasi, None, Literal),
            ("ii_pj_alamat", DCT.ii_pj_alamat, None, Literal),
            ("ii_pj_email", DCT.ii_pj_email, None, Literal),
            ("ii_pj_faksimile", DCT.ii_pj_faksimile, None, Literal),
            ("ii_pj_jabatan", DCT.ii_pj_jabatan, None, Literal),
            ("ii_pj_nama", DCT.ii_pj_nama, None, Literal),
            ("ii_pj_telepon", DCT.ii_pj_telepon, None, Literal),
            ("ii_unit_eselon1", DCT.ii_unit_eselon1, None, Literal),
            ("ii_unit_eselon2", DCT.ii_unit_eselon2, None, Literal),
            ("iii_latar_belakang_kegiatan", DCT.iii_latar_belakang_kegiatan, None, Literal),
            ("iii_tujuan_kegiatan", DCT.iii_tujuan_kegiatan, None, Literal),
            ("indikator_prioritas", DCT.indikator_prioritas, None, Literal),
            ("interpretasi", DCT.interpretasi, None, Literal),
            ("iv_cakupan_wilayah_pengumpulan_data", DCT.iv_cakupan_wilayah_pengumpulan_data, None, Literal),
            ("iv_frekuensi_penyelanggara", DCT.iv_frekuensi_penyelanggara, None, Literal),
            ("iv_kegiatan_ini_dilakukan", DCT.iv_kegiatan_ini_dilakukan, None, Literal),
            ("iv_metode_pengumpulan_data", DCT.iv_metode_pengumpulan_data,None, Literal),
            ("iv_sarana_pengumpulan_data", DCT.iv_sarana_pengumpulan_data, None, Literal),
            ("iv_tipe_pengumpulan_data", DCT.iv_tipe_pengumpulan_data, None, Literal),
            ("iv_unit_pengumpulan_data", DCT.iv_unit_pengumpulan_data, None, Literal),
            ("jenis", DCT.jenis, None, Literal),
            ("jenis_statistik", DCT.jenis_statistik, None, Literal),
            ("judul_kegiatan", DCT.judul_kegiatan, None, Literal),
            ("kodereferensi", DCT.kodereferensi, None, Literal),
            ("kriteria_prioritas", DCT.kriteria_prioritas, None, Literal),
            ("level_estimasi", DCT.level_estimasi, None, Literal),
            ("metode_perhitungan", DCT.metode_perhitungan, None, Literal),
            ("produsen_data_city_code", DCT.produsen_data_city_code, None, Literal),
            ("produsen_data_name", DCT.produsen_data_name, None, Literal),
            ("produsen_data_province_code", DCT.produsen_data_province_code, None, Literal),
            ("publishing_status", DCT.publishing_status, None, Literal),
            ("rumus", DCT.rumus, None, Literal),
            ("satuan", DCT.satuan, None, Literal),
            ("ukuran", DCT.ukuran, None, Literal),
            ("sektor_kegiatan", DCT.sektor_kegiatan, None, Literal),
            ("submission_period", DCT.submission_period, None, Literal),
            ("tahun_kegiatan", DCT.tahun_kegiatan, None, Literal),
            ("theme", DCT.theme, None, Literal),
            ("total_msind", DCT.total_msind, None, Literal),
            ("total_msvar", DCT.total_msvar, None, Literal),
            ("vi_apakah_melakukan_pelatihan_petugas", DCT.vi_apakah_melakukan_pelatihan_petugas, None, Literal),
            ("vi_apakah_melakukan_penyesuaian_nonrespon", DCT.vi_apakah_melakukan_penyesuaian_nonrespon, None, Literal),
            ("vi_apakah_melakukan_uji_coba", DCT.vi_apakah_melakukan_uji_coba, None, Literal),
            ("vi_jumlah_petugas_enumerator", DCT.vi_jumlah_petugas_enumerator, None, Literal),
            ("vi_jumlah_petugas_supervisor", DCT.vi_jumlah_petugas_supervisor, None, Literal),
            ("vi_metode_pemeriksaan_kualitas_pengumpulan_data", DCT.vi_metode_pemeriksaan_kualitas_pengumpulan_data, None, Literal),
            ("vii_metode_analisis", DCT.vii_metode_analisis, None, Literal),
            ("vii_tahapan_pengolahan_data", DCT.vii_tahapan_pengolahan_data, None, Literal),
            ("vii_tingkat_penyajian_hasil_analisis", DCT.vii_tingkat_penyajian_hasil_analisis, None, Literal),
            ("vii_unit_analisis", DCT.vii_unit_analisis, None, Literal),
            ("viii_ketersediaan_produk_digital", DCT.viii_ketersediaan_produk_digital, None, Literal),
            ("viii_ketersediaan_produk_mikrodata", DCT.viii_ketersediaan_produk_mikrodata, None, Literal),
            ("viii_ketersediaan_produk_tercetak", DCT.viii_ketersediaan_produk_tercetak, None, Literal),
